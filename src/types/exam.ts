...
export interface Exam {
  ...
  lesson?: string; // Tên bài hoặc số bài: "Bài 1", "Bài 14", "Khảo sát hàm số"...
  lessonNumber?: string; // Số bài chuẩn hóa: "01", "14"...
  attemptNumber?: string | number; // Lần kiểm tra: "01", 1, 2...
